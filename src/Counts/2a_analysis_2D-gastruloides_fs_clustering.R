...
# Cairo(file=paste(directory,"/figures/2dgas-fs/PCA/PCA-Plot-1-2.svg",sep=""),type="svg",width = 4,height = 4,units="cm",dpi=20)
# PCAPlot(dataset.fs)
# dev.off()
# 
...
# 
# Cairo(file=paste(directory,"/figures/2dgas-fs/PCA/PCA-JackStrawPlot-raw.svg",sep=""),type="svg",width = 6,height = 4,units="cm",dpi=20)
# JackStrawPlot(dataset.fs,dims = 1:30)
# dev.off()
# 
# jackstraw.pval <- -log10(dataset.fs@reductions$pca@jackstraw@overall.p.values[,"Score"])
# ndims <- 20
# Cairo(file=paste(directory,"/figures/2dgas-fs/PCA/PCA-JackStrawPlot-pval.svg",sep=""),type="svg",width = 4,height = 4,units="cm",dpi=20)
...
# dev.off()
# 
# Cairo(file=paste(directory,"/figures/2dgas-fs/PCA/PCA-ElbowPlot.svg",sep=""),type="svg",width = 4,height = 4,units="cm",dpi=20)
...
#                        n.components=2)
# 
# dataset.fs@reductions$umap@cell.embeddings[,1] = -dataset.fs@reductions$umap@cell.embeddings[,1]
# dataset.fs@reductions$umap@cell.embeddings[,2] = -dataset.fs@reductions$umap@cell.embeddings[,2]
# 
# size=10
# Cairo(file=paste(directory,"/figures/2dgas-fs/GenePlots/UMAP-Condition.svg",sep=""),type="svg",width = 5,height = 4,units="cm",dpi=20)
...
# 
# size=10
# filename = paste(directory,"/figures/2dgas-fs/GenePlots/Cluster-stability-analysis.svg",sep="")
...
# 
# Cairo(file=paste(directory,"/figures/2dgas-fs/GenePlots/UMAP-Cluster-raw.svg",sep=""),type="svg",width = 4,height = 4,units="cm",dpi=20)
...
# new.cluster.ids <- c("NasMes","Epi","Epi","PS","PS","Epi",
#                      "AntPS")
# new.cluster.ids.order <- c("Epi","AntPS","PS","NasMes")
# 
# 
...
# 
# Cairo(file=paste(directory,"/figures/2dgas-fs/GenePlots/UMAP-Cluster-annotated.svg",sep=""),type="svg",width = 4,height = 4,units="cm",dpi=20)
...
# 
# # Save the dataset
# saveRDS(dataset.fs,file = paste(directory,"/rds/2dgas_t36_fs.rds",sep=""))
...
filename = paste(directory,"/figures/2dgas-fs/GenePlots/dotplot_list-genes.svg",sep="")
...
for (gene in genes.to.plot){
  Cairo(file=paste(directory,"/figures/2dgas-fs/GenePlots/UMAP-",gene,".svg",sep=""),type="svg",width = 4,height = 4,units="cm",dpi=20)
  print(FeaturePlot(dataset.fs,gene,pt.size = 0.5,label=FALSE,order = TRUE,label.size = 5)+
          theme(axis.ticks.x = element_blank(),axis.text.x = element_blank(),axis.title.x=element_blank(),
                axis.ticks.y = element_blank(),axis.text.y = element_blank(),axis.title.y=element_blank(),
                axis.line=element_blank()))
  dev.off()
  Cairo(file=paste(directory,"/figures/2dgas-fs/GenePlots/VLN-",gene,".svg",sep=""),type="svg",width = 4,height = 4,units="cm",dpi=20)
...
for (celltype.i in new.cluster.ids.order){
  ...
  Cairo(file=paste(directory,"/figures/2dgas-fs/BarplotCondition/BarPlot-Condition-",celltype.i,".jpg",sep=""),type="svg",width = 5,height = 5,units="cm",dpi=20)
...
for (gene in genes.to.plot){
  Cairo(file=paste(directory,"/figures/2dgas-fs/GenePlots/VLN2-",gene,".svg",sep=""),type="svg",width = 5,height = 5,units="cm",dpi=20)
...
for (time.emb in list.time.emb){
  ...
  Cairo(file=paste(directory,"/figures/2dgas-fs/Comparison/",time.gas,"vs",time.emb,"_mnn_heatmap_pearson-correlation.svg",sep="")
  ...
  Cairo(file=paste(directory,"/figures/2dgas-fs/Comparison/",time.gas,"vs",time.emb,"_mnn_heatmap_euclidean-distance.svg",sep="")
        ,type="svg",width = 3+n.celltype.emb,height = 2+n.celltype.gas,units="cm",dpi=20)
  print(ggplot(data = matrix.melted, aes(x=Var1, y=Var2, fill=value)) + 
          geom_tile(color = "white")+
...
Cairo(file=paste(directory,"/figures/2dgas-fs/Comparison/",time.fs,"vs",time.ss3,"_mnn_heatmap_pearson-correlation.svg",sep="")
...
Cairo(file=paste(directory,"/figures/2dgas-fs/Comparison/",time.fs,"vs",time.ss3,"_mnn_heatmap_euclidean-distance.svg",sep="")
      ,type="svg",width = 3+n.celltype.ss3,height = 2+n.celltype.fs,units="cm",dpi=20)
print(ggplot(data = matrix.melted, aes(x=Var1, y=Var2, fill=value)) + 
        geom_tile(color = "white")+
        scale_fill_gradient2(low = "red", high = "blue", mid = "white", 
...
for (gene in genes.to.plot){
  Cairo(file=paste(directory,"/figures/2dgas-fs/ExpressionByCondition/VLNPlot-ByCondition-",celltype.i,"-",gene,".svg",sep=""),type="svg",width = 2,height = 2.5,units="cm",dpi=20)
